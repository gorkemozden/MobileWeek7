...
class BoardPresenter implements BoardListener {
    ...
    private Board board;
    private List<CellListener> cellListeners = new ArrayList<>();
    ...
    public void addCellClickListener(CellListener listener){
    ...
    static class CellListener implements View.OnClickListener{
        ...
        byte row;
        byte col;
        public CellListener( BoardPresenter presenter, byte row, byte col){
            this.row = row;
            this.col = col;
